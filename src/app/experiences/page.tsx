...
const canonicalUrl = `${siteUrl}/experiences`;
const socialImage = `${siteUrl}/media/thirsty-experiences-menorca-og.webp`;

export const metadata: Metadata = {
  title: { absolute: "Thirsty Experiences | Viatge de final de curs a Menorca" },
  description:
  ...
  openGraph: {
    ...
    images: [{ url: socialImage, width: 1200, height: 630, alt: "Viatge de final de curs a Menorca" }],
  },
  twitter: {
...
export default function ThirstyExperiencesPage() {
  return (
    <>
      ...
      <main>
        <ExperienceCollages />
        <section className="menorca-title" aria-labelledby="menorca-title"><h2 id="menorca-title">Menorca</h2></section>
        <GroupFinder />
      </main>
        ...
        <div className="footer__top">
          <div className="footer__brand-row">
            <div className="footer__brand-lockup" aria-label="Thirsty i Neway">
              <Image className="brand-logo brand-logo--footer" src="/media/thirsty-logo-transparent.webp" alt="Thirsty" width={800} height={312} />
              <span aria-hidden="true">×</span>
              <Image className="footer__neway" src="/media/neway-logo-blanc.png" alt="Neway" width={1126} height={146} />
            </div>
            <h2 className="footer__title">See you<br />in Menorca.</h2>
          </div>
          <div className="footer__meta-row">
            <div className="footer__description"><p>Experiències de final de curs.</p></div>
            <SocialLinks />
          </div>
        </div>
      </footer>
